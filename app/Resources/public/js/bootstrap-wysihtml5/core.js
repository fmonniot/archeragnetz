!function($, wysi) {
    ...
    var templates = function(key, locale) {
        ...
        var tpl = {
            ...
            "emphasis":    "<li>" +
                               "<div class='btn-group'>" +
                                   "<a class='btn' data-wysihtml5-command='bold' title='" + locale.emphasis.bold + " [CTRL+B]'><i class='icon-bold'></i></a>" +
                                   "<a class='btn' data-wysihtml5-command='italic' title='" + locale.emphasis.italic + " [CTRL+I]'><i class='icon-italic'></i></a>" +
                                   "<a class='btn' data-wysihtml5-command='underline' title='" + locale.emphasis.underline + " [CTRL+U]'><i class='icon-underline'></i></a>" +
                               "</div>" +
                           "</li>",
            "lists":       "<li>" +
                               "<div class='btn-group'>" +
    ...
    var locale = $.fn.wysihtml5.locale = {
    	...
    	fr: {
                ...
                lists: {
                    unordered: "List à puce",
                    ordered: "Liste numérotée",
                    outdent: "Augmenter le retrait",
                    indent: "Réduire le retrait"
                },
                link: {
